 ...
 */
#define METER_OBJECT_ID 3424
lwm2m_object_t *get_meter_object(void);
void free_meter_object(lwm2m_object_t *object);
void display_meter_object(lwm2m_object_t *objectP);

/*
 * object_device_extension.c
 */
#define EXTENSION_OBJECT_ID 3410
lwm2m_object_t *get_extension_object(void);
void free_extension_object(lwm2m_object_t *object);
void display_extension_object(lwm2m_object_t *objectP);
